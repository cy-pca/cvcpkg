#!/usr/bin/env bash
# recipes/typing-inspection-cp313t/build.sh — build typing-inspection 0.4.2 FROM SOURCE (generated).
#
...
echo "typing-inspection-cp313t: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "typing-inspection-cp313t: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "typing-inspection-cp313t: built $(basename "${WHEEL}")"
...
unset PYTHONPATH
cvc_python_check "import typing_inspection"
