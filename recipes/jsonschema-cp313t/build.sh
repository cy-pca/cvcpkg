#!/usr/bin/env bash
# recipes/jsonschema-cp313t/build.sh — build jsonschema 4.17.3 FROM SOURCE (generated).
#
...
#
# BUILD BACKEND: hatchling-cp313t, hatch-vcs-cp313t, hatch-fancy-pypi-readme-cp313t, packaging-cp313t, pathspec-cp313t, pluggy-cp313t, trove-classifiers-cp313t, calver-cp313t
...
echo "jsonschema-cp313t: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "jsonschema-cp313t: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "jsonschema-cp313t: built $(basename "${WHEEL}")"
...
unset PYTHONPATH
cvc_python_check "import jsonschema"
