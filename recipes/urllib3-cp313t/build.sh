#!/usr/bin/env bash
# recipes/urllib3-cp313t/build.sh — build urllib3 2.7.0 FROM SOURCE (generated).
#
...
#
# BUILD BACKEND: hatchling-cp313t, hatch-vcs-cp313t, setuptools-scm-cp313t, packaging-cp313t, pathspec-cp313t, pluggy-cp313t, trove-classifiers-cp313t, calver-cp313t
...
echo "urllib3-cp313t: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "urllib3-cp313t: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "urllib3-cp313t: built $(basename "${WHEEL}")"
...
unset PYTHONPATH
cvc_python_check "import urllib3"
