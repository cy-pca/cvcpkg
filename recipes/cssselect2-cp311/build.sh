...
echo "cssselect2-cp311: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "cssselect2-cp311: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "cssselect2-cp311: built $(basename "${WHEEL}")"
