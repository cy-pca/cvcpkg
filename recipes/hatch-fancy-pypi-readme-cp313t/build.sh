#!/usr/bin/env bash
# recipes/hatch-fancy-pypi-readme-cp313t/build.sh — build hatch-fancy-pypi-readme 24.1.0 FROM SOURCE (generated).
#
...
#
# BUILD BACKEND: hatchling-cp313t, packaging-cp313t, pathspec-cp313t, pluggy-cp313t, trove-classifiers-cp313t, calver-cp313t
...
echo "hatch-fancy-pypi-readme-cp313t: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "hatch-fancy-pypi-readme-cp313t: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "hatch-fancy-pypi-readme-cp313t: built $(basename "${WHEEL}")"
...
unset PYTHONPATH
cvc_python_check "import hatch_fancy_pypi_readme"
