...
echo "tinyhtml5-cp313t: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "tinyhtml5-cp313t: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "tinyhtml5-cp313t: built $(basename "${WHEEL}")"
