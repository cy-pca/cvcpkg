#!/usr/bin/env bash
# recipes/hatch-vcs-cp313t/build.sh — build hatch-vcs 0.4.0 FROM SOURCE (generated).
#
...
echo "hatch-vcs-cp313t: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "hatch-vcs-cp313t: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "hatch-vcs-cp313t: built $(basename "${WHEEL}")"
...
unset PYTHONPATH
cvc_python_check "import hatch_vcs"
