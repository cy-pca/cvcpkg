#!/usr/bin/env bash
# recipes/black-cp311/build.sh — build black 26.5.1 FROM SOURCE (generated).
#
...
#
# BUILD BACKEND: hatch-fancy-pypi-readme-cp311, hatch-vcs-cp311, hatchling-cp311, pluggy-cp311, trove-classifiers-cp311, calver-cp311
...
echo "black-cp311: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "black-cp311: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "black-cp311: built $(basename "${WHEEL}")"
