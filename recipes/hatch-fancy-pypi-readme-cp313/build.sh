#!/usr/bin/env bash
# recipes/hatch-fancy-pypi-readme-cp313/build.sh — build hatch-fancy-pypi-readme 24.1.0 FROM SOURCE (generated).
#
...
echo "hatch-fancy-pypi-readme-cp313: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "hatch-fancy-pypi-readme-cp313: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "hatch-fancy-pypi-readme-cp313: built $(basename "${WHEEL}")"
