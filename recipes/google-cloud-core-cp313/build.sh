#!/usr/bin/env bash
# recipes/google-cloud-core-cp313/build.sh — build google-cloud-core 2.6.0 FROM SOURCE (generated).
#
...
echo "google-cloud-core-cp313: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "google-cloud-core-cp313: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "google-cloud-core-cp313: built $(basename "${WHEEL}")"
