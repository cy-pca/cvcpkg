#!/usr/bin/env bash
# recipes/black-cp313t/build.sh — build black 26.5.1 FROM SOURCE (generated).
#
...
#
# BUILD BACKEND: hatch-fancy-pypi-readme-cp313t, hatch-vcs-cp313t, hatchling-cp313t, pluggy-cp313t, trove-classifiers-cp313t, calver-cp313t
...
echo "black-cp313t: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "black-cp313t: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "black-cp313t: built $(basename "${WHEEL}")"
