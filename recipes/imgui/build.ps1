...
# so a Windows DLL would export nothing and downstream links would fail. cvcGL links
# this static lib directly (it is itself built static into the example binaries).
# The backends/ tree ships as SOURCE (headers + .cpp) — cvcGL compiles the stock
# imgui_impl_opengl3.cpp glue it needs.
