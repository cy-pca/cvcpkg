...
# Cap parallelism for the Windows-host wasm build: emcc compiles are ~1-2 GB RSS
# each, so the default nproc (~20) OOMs the compiler mid-build on the 16 GB Windows
# builder. 6 is a safe ceiling; a smaller CVC_JOBS still wins.
