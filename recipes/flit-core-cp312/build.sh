...
echo "flit-core-cp312: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "flit-core-cp312: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "flit-core-cp312: built $(basename "${WHEEL}")"
