#!/usr/bin/env bash
# recipes/black-cp313/build.sh — build black 26.5.1 FROM SOURCE (generated).
#
...
#
# BUILD BACKEND: hatch-fancy-pypi-readme-cp313, hatch-vcs-cp313, hatchling-cp313, pluggy-cp313, trove-classifiers-cp313, calver-cp313
...
echo "black-cp313: building with ${PY_EXE}"
...
[ -n "${WHEEL}" ] || { echo "black-cp313: no wheel produced under ${WHEELHOUSE}" >&2; exit 1; }
echo "black-cp313: built $(basename "${WHEEL}")"
